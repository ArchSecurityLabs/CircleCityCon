...
<div id="bodyWrapper">
    ...
    -->
            ...
            <div id="bodyContent">
                    <?php include "includes/training/training.php"?>
                    <?php include "includes/training/training1.php"?>
                    <?php include "includes/training/training2.php"?> 
                    <?php include "includes/training/training3.php"?>
                    <?php include "includes/training/training4.php"?>
                    <?php include "includes/training/training5.php"?>
            </div>
