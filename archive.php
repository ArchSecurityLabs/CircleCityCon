...
<TITLE>.:CircleCityCon:. [Indianapolis, Indiana] - Archive</TITLE>
...
<div id="bodyWrapper">
    ...
    <?php include "includes/header.php"; ?>
            ...
            <div id="breadCrumbsWrapper">
                ...
                <p>
                    ...
                    <a href="index.php" title="home">home</a> > archive
    ...
    -->
            ...
            <div id="bodyContent">
                <p>
                    since this is the first year, we don't have an archive yet.
                </p>
            </div>
